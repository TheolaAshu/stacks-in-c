/*C program to count the number of occurence of each word in the file.*/
...
int main(){
    ...
    printf("Enter any number greater than the number of words in that file else program crashes\n");
    scanf("%d", &max);
